$(document).ready(function(){
	...
	$('#turn').on('click', function(e){
		...
		button.progressTimed(30, function(){
			...
			PassTurn();
            button.css("background-color", PlayerColors[Turn]);
            bar.css("background-color", PlayerColors[GetNextTurn()]);
		});
	});
...
(function($){
	...
	$.fn.progressInitialize = function(){
		...
		return this.each(function(){
            ...
            // Init default bars
            button.css("background-color", PlayerColors[0]);
            bar.css("background-color", PlayerColors[1]);
