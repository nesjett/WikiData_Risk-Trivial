...
var colorPicker = (function() {
    //var colors = ["rgba(51,51,51,.1)", "#FFBE53", "#2980B9", "#282741"];
    //var colors = ["rgba(51,51,51,.1)","rgba(100,21,251,.1)","rgba(151,151,151,.1)"];
...
function handleEvent(e, map) {
    ...
    var targetR = calcPageFillRadius(point.x, point.y);
